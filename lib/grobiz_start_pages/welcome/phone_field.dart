...
import 'package:poultry_a2z/grobiz_start_pages/welcome/coutry_picker_dialog.dart';
        ...
        children: <Widget>[
          ...
          Expanded(
              child: TextFormField(
                ...
                maxLength: widget.disableLengthCheck ? null : _selectedCountry!=null ? _selectedCountry!.maxLength : null,
              ...
              Container(
                ...
                child: IconButton(
                    onPressed: ()=>{
                      ...
                      if(_selectedCountry!=null){
                        if (!widget.disableLengthCheck &&  widget.controller!.text!= null) {
                          if(widget.controller!.text.length >= _selectedCountry!.minLength &&
                              widget.controller!.text.length <= _selectedCountry!.maxLength){
