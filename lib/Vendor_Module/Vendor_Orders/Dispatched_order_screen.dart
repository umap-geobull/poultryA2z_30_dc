...
class Dispatched_Order_List extends StatefulWidget {
  late String Vendorid;
  Dispatched_Order_List(String vendorid)
  {
    Vendorid=vendorid;
  }

  @override
  State<Dispatched_Order_List> createState() => Dispatched_Order_ListState();
}

class Dispatched_Order_ListState extends State<Dispatched_Order_List> {
  ...
  Future<String?> getBaseUrl() async {
    ...
    if(baseUrl!=null){
      setState(() {
        ...
        get_Vendor_Dispatched_order_products();
      });
    }
    return null;
  }
  ...
  Widget Brandcard(String product_order_auto_id,
    ...
    return GestureDetector(
      onTap: () {
        Navigator.of(context).push(MaterialPageRoute(builder: (context) =>
            order_details(order_auto_id: product_order_auto_id,vendor_id: user_id,)));
      },
      child: SizedBox(
        // height: 150,
        // height: 230,
  ...
  get_Vendor_Dispatched_order_products() async {
    if (this.mounted) {
      setState(() {
    ...
    restApis.getVendor_Dispatched_orders(user_id,baseUrl).then((
        value) {
      if (value != null) {
        if (mounted) {
          setState(() {
