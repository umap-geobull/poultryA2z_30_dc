...
class Cancelled_Order extends StatefulWidget {
  late String Vendorid;
  Cancelled_Order(String vendorid)
  {
    Vendorid=vendorid;
  }
  @override
  State<Cancelled_Order> createState() => Cancelled_OrderState();
}

class Cancelled_OrderState extends State<Cancelled_Order> {
  ...
  Future<String?> getBaseUrl() async {
    ...
    if(baseUrl!=null){
      setState(() {
        ...
        get_Vendor_Cancelled_order_products();
      });
    }
    return null;
  }
  ...
  Widget build(BuildContext context) {
    return Container(
        child: Container(
          ...
          ):Order_dataList!.isNotEmpty ?ListView.builder(
  ...
  void get_Vendor_Cancelled_order_products() async {
    if (this.mounted) {
      setState(() {
        isApiCallProcess = true;
    ...
    restApis.getVendor_Canceled_orders(user_id,baseUrl).then((value) {
      if (value != null) {
        if (mounted) {
          setState(() {
