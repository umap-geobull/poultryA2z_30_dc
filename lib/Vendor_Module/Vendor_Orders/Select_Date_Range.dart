...
class Select_Date_Range extends StatefulWidget {
   Select_Date_Range({Key? key,  required this.type}) : super(key: key);
  String type;
             ...
             child: ElevatedButton(
               ...
               onPressed: () {
                 ...
                 if(widget.type == "reports")
                 {
                   ...
                   Navigator.of(context).push(MaterialPageRoute(builder: (context) => Vendor_Orders_Reports( s_date: start_date,e_date: end_date, s_date1: start_date1,e_date1: end_date1,vendor_id: '')));
                 ...
                 {
                   Navigator.of(context).pop();
                   Navigator.of(context).push(MaterialPageRoute(builder: (context) => Venders_Sales(s_date: start_date,e_date: end_date, s_date1: start_date1,e_date1: end_date1,vendor_id: '')));
