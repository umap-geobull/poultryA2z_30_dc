...
import 'package:poultry_a2z/Vendor_Module/Vendor_Invoice/widget/button_widget.dart';
...
class _Vendor_Invoice_ScreenState extends State<Vendor_Invoice_Screen> {
  ...
  //late List<InvoiceItem> inventory_models;
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Text("Phone no.: +919600000000",
                        style: TextStyle(color: Colors.black, fontSize: 14)),
                    Text("Email: rahulenterpriese@gmail.com",
                        style: TextStyle(color: Colors.black, fontSize: 14)),
                  ],
                ),
              ),
  ...
  Widget buildDataTable() {
    final columns = ['Product Name', 'Date', 'Quantity', 'Tax', 'Unit Prize'];
            ...
            if (customerNameController.text == "" ||
              ...
              final invoice = Invoice(
                supplier: Supplier(
                  ...
                  phone: '+919999999999',
                  email: 'rahulenterprises@gmail.com',
                ),
                customer: Customer(
