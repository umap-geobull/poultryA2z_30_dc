...
class Rest_Apis {
  Future<Coupen_Code_Info_Model?> getCoupen_CodeList(String vendorId, String baseUrl) async {
  ...
  Future<String?> add_coupen_code(String userId, String type,String coupenCode, String coupenCodeValue, String coupenCodeDesc, String startDate, String endDate, String baseUrl) async {
    final body = {
      "user_auto_id": userId,
      "type": type,
  ...
  Future<String?> update_coupen_code(String? coupenId,String userId, String type,String coupenCode, String coupenCodeValue, String coupenCodeDesc, String startDate, String endDate, String baseUrl) async {
    final body = {
  ...
  Future<int?> Delete_coupon_code(String? coupenId,String userId, String baseUrl) async {
    final body = {
      "user_auto_id": userId,
      "coupon_auto_id":coupenId,
