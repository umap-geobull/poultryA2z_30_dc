...
class BtoCSignup extends StatefulWidget {
  ...
  @override
  BtoCSignupState createState() => BtoCSignupState(mobile_number,country_code,phone_code);
...
/*                          SizedBox(
  ...
  Future<void> saveLoginSession(String userAutoId, String userType, String category_id) async {
