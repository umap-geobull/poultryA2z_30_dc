...
class _FinalPayScreenState extends State<FinalPayScreen> {
  ...
  String transaction_id='',payment_status='Pending';

  List<GetAdminCartProductLists> cartProductList=[];
  String Totalprice='',currency='',selectcolor="Select Color Name";
              ...
              Container(
                child: Column(
                  ...
                  children: [
                    ...
                    cartModel.colorName!=selectcolor && cartModel.colorName!=''?
                    Row(
                      children: [
                        const Text('Color:'),
                        const SizedBox(
                    ...
                    Row(
                      children: [
                        cartModel.originalProductPrice.toString()!=cartModel.product_final_price.toString()?
                        Text(
  ...
  placeOrder(String transactionId) async {
    if(mounted){
      setState(() {
        isApiCallProcessing=true;
    ...
    String productAutoId='',size='',quantity='',productPrice='',productOfferPercentage='',
        productFinalPrice='',productImage='',addedBy='',addedById='',product_name='';
    ...
    for(int index=0;index<cartProductList.length;index++){
      ...
      if(index==0){
        ...
        product_name=product_name+cartProductList[index].productName;
        size=size+_size;
            ...
            children: <Widget>[
              Container(
                child: Column(
                  ...
                  children: <Widget>[
                    Text('Congratulations',style: TextStyle(color: Colors.orangeAccent,fontSize: 20),),
                    SizedBox(height: 10,),
