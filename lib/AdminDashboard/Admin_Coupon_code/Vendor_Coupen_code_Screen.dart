...
class _Vendor_Coupen_codeState extends State<Vendor_Coupen_code> {
          ...
          Container(
            ...
            child: ListView.builder(
                ...
                itemBuilder: (context, index) =>
                    CategoryCard_(user_id, GetcuponcodeList![index].sId,
                        GetcuponcodeList![index].type,GetcuponcodeList![index].coupenCode,
                        GetcuponcodeList![index].coupenCodeValue,GetcuponcodeList![index].coupenCodeDesc,
                        GetcuponcodeList![index].startDate, GetcuponcodeList![index].endDate )
            ),
          ):
          Container(
            alignment: Alignment.center,
  ...
  void getCoupen_Code_List() async {
    if (this.mounted) {
      setState(() {
    ...
    restApis.getCoupen_CodeList(user_id,baseUrl, admin_auto_id).then((value) {
      if (value != null) {
        if(this.mounted) {
          setState(() {
        ...
        if (coupen_code_info_model != null) {
          ...
          Fluttertoast.showToast(
            msg: "No coupon code found please add",
  ...
  showAlert(String? sId, String user_id) async {
    showDialog(
      context: context,
  ...
  void update_Coupen_code(String sId, String user_id, String coupen_code_type,
      String coupen_code, String coupen_code_value, String coupen_code_desc, String start_date, String end_date) {
    setState(() {
      isApiCallProcessing = true;
    });
    ...
    restApis.update_coupen_code(sId, user_id, coupen_code_type, coupen_code,
        coupen_code_value, coupen_code_desc, start_date, end_date, baseUrl, admin_auto_id).then((value){
      if(value!=null){
  ...
  void Delete_Coupen_Code(String? sId, String user_id) {
    ...
    restApis.Delete_coupon_code(sId, user_id, baseUrl, admin_auto_id).then((value){
