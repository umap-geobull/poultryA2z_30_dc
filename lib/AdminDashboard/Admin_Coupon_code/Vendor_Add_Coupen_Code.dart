...
class _Vendor_add_Coupen_codeState extends State<Vendor_add_Coupen_code> {
  ...
  void Add_Coupen_Code(String userId, String type, String coupenCode,
      String coupenCodeValue, String coupenCodeDesc, String startDate, String endDate) {
    setState(() {
    ...
    restApis.add_coupen_code(userId, type, coupenCode, coupenCodeValue, coupenCodeDesc,
        startDate, endDate, baseUrl, admin_auto_id).then((value){
      if(value!=null){
