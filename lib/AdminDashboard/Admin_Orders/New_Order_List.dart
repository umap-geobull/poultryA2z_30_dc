...
class New_Order_ListState extends State<New_Order_List> {
  ...
  String user_id = "",admin_auto_id='',select_color='Select Color Name';
      ...
      String quantity)
  {
    return GestureDetector(
      onTap: (){
        print("orderid"+orderId+''+productOrderAutoId);
                            ...
                            child: ClipRRect(
                              ...
                              child: productImg != ''
                                  ? CachedNetworkImage(
                                      ...
                                      width: 90,
                                      imageUrl:
                                          baseUrl+product_base_url + productImg,
  ...
  void get_Vendor_new_order_products() async {
    ...
    restApis.getVendor_New_orders(user_id,admin_auto_id,baseUrl).then((value) {
