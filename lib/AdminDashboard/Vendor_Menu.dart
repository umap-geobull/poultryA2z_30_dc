...
import 'Admin_Orders/Vendor_Order_Screen.dart';
...
class Vendor_Menu extends StatelessWidget {
  ...
  Vendor_Menu(this.user_id,this.admin_id);
          ...
          child: ListView.builder(
              ...
              itemBuilder: (context, index) => CategoryCard(
                ...
                press: () {
                  ...
                  else if(vendor_menu_List[index]["text"] == "Approvals") {
                    Navigator.push(context, MaterialPageRoute(builder: (context) => Approval_Screen()));
                  }
                  else if(vendor_menu_List[index]["text"] == "Settings") {
                    Navigator.push(context, MaterialPageRoute(builder: (context) => SettingScreen()));
                  }
                  else if(vendor_menu_List[index]["text"] == "Vendor List") {
