...
class Customer_Order_detail extends StatefulWidget {
  String orderId;
  String productOrderAutoId;
  String userid;

  Customer_Order_detail(this.userid,this.orderId, this.productOrderAutoId);

  @override
  State<StatefulWidget> createState() => Customer_Order_detailState(userid,orderId, productOrderAutoId);
}

class Customer_Order_detailState extends State<Customer_Order_detail> {
  String orderId, productOrderAutoId;
  Customer_Order_detailState(this.user_id,this.orderId, this.productOrderAutoId);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text("Order details", style: TextStyle(color: appBarIconColor,fontSize: 18)),
        leading: IconButton(
          ...
          GestureDetector(
            onTap: () {
              Navigator.push(
                context,
                MaterialPageRoute(
                    builder: (context) => Customer_Order_detail(user_id,otherProduct[index].orderId,otherProduct[index].productOrderAutoId)),
              );
            },
            child: Container(
