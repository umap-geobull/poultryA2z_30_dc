...
class EditAddress extends StatefulWidget {
  ...
  EditAddress(this.addressDetails);

  @override
  _EditAddress createState() => _EditAddress(addressDetails);
}
...
class _EditAddress extends State<EditAddress> {
  ...
  _EditAddress(this.addressDetails);

  late String cname, mobile, pincode, area, latitude='1.2546',
      longitude='2.4586',city,state='Maharashtra',country='India',address,addtype='Home';
    ...
    return Scaffold(
      appBar: AppBar(
        backgroundColor: kPrimaryColor1,
          title: const Text("Edit Address", style: TextStyle(color: Colors.white, fontSize: 18, fontWeight: FontWeight.bold)),
          leading: IconButton(
...
*/
  ...
  editUserAddress() async {
    ...
    var url = Uri.parse(baseUrl+'api/'+edit_user_address);

    final body = {
      "address_auto_id": addressDetails.id,
  ...
  void setData() {
    tv_name.text = addressDetails.name;
    tv_mobile.text = addressDetails.mobileNo;
    tv_pincode.text =addressDetails.pincode;
    tv_address.text =addressDetails.addressDetails;
    tv_area.text = addressDetails.area;
   // tv_latitude.text =addressDetails.name;
    //tv_longitude.text = addressDetails.name;
    tv_city.text =addressDetails.city;
    tv_state.text = addressDetails.state;
    tv_country.text =addressDetails.country;
    addtype = widget.addressDetails.addressType;
  }
}
