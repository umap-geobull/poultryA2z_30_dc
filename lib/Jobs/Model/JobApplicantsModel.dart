class JobApplicants {
  ...
  late final List<GetJobApplicants> data;

  JobApplicants.fromJson(Map<String, dynamic> json){
    status = json['status'];
    msg = json['msg'];
    data = List.from(json['data']).map((e)=>GetJobApplicants.fromJson(e)).toList();
  }
...
class GetJobApplicants {
  GetJobApplicants({
    required this.id,
    required this.userAutoId,
    required this.jobAutoId,
  ...
  GetJobApplicants.fromJson(Map<String, dynamic> json){
    id = json['_id'];
    userAutoId = json['user_auto_id'];
    jobAutoId = json['job_auto_id'];
