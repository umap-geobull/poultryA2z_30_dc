class MainCategoryComponets {
  MainCategoryComponets({
    required this.status,
    required this.msg,
    required this.getMainCategoryComponents,
  });
  late final String status;
  late final String msg;
  late final List<GetMainCategoryComponents> getMainCategoryComponents;

  MainCategoryComponets.fromJson(Map<String, dynamic> json){
    status = json['status'];
    msg = json['msg'];
    getMainCategoryComponents = List.from(json['get_main_category_components']).map((e)=>GetMainCategoryComponents.fromJson(e)).toList();
  }
  ...
  Map<String, dynamic> toJson() {
    ...
    _data['status'] = status;
    _data['msg'] = msg;
    _data['get_main_category_components'] = getMainCategoryComponents.map((e)=>e.toJson()).toList();
    return _data;
  }
}

class GetMainCategoryComponents {
  GetMainCategoryComponents({
    required this.id,
  ...
  GetMainCategoryComponents.fromJson(Map<String, dynamic> json){
    id = json['_id'];
