...
import '../../Home/Components/AddNewComponent/models/home_subcategory_details.dart';
import '../../Home/Components/component_constants.dart';

class ShowSubcategoryFromMain extends StatefulWidget {
  String component_id;
  String main_category_id;

  ShowSubcategoryFromMain(this.component_id, this.main_category_id);

  @override
  _ShowSubcategoryFromMain createState() => _ShowSubcategoryFromMain(component_id);
}

class _ShowSubcategoryFromMain extends State<ShowSubcategoryFromMain> {

  String component_id;

  _ShowSubcategoryFromMain(this.component_id);
  ...
  List<Content> subcategoryListUi=[];
  ...
  void getBaseUrl() async {
    ...
    if(baseUrl!=null && userId!=null && apptypeid!=null && adminId!=null){
        ...
        MaterialPageRoute(
            builder: (context) =>
                Product_List(
                  type: "subcategory",
                  main_cat_id: '',
                  sub_cat_id: subcategoryList[index].id,
                  brand_id: '',
                  home_componet_id: '',
                  offer_id: '',)),);
    }
  ...
  Future getSubCategoriesUi() async {
    ...
    if (response.statusCode == 200) {
      ...
      if(status==1){
        ...
        subcategoryListUi=homeSubcategoryDetails.getHomeComponentList[0].content;
