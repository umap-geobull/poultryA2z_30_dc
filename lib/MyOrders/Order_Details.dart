...
import '../RatingReview/AddReview.dart';
...
class Order_details extends StatefulWidget {
  ...
  Order_details(this.orderId, this.productOrderAutoId);

  @override
  State<StatefulWidget> createState() => OrderDetailsState(orderId, productOrderAutoId);
}

class OrderDetailsState extends State<Order_details> {
  String orderId, productOrderAutoId;
  OrderDetailsState(this.orderId, this.productOrderAutoId);
              ...
              Expanded(
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    ...
                    Row(
                      children: [
                        mainProduct[0].productPrice!=mainProduct[0].productFinalPrice.toString()? Text(
        ...
        GestureDetector(
          onTap: () {
            Navigator.push(
              context,
              MaterialPageRoute(
                  builder: (context) => Order_details(otherProduct[index].orderId,otherProduct[index].productOrderAutoId)),
            );
          },
          child: Container(
                    ...
                    children: <Widget>[
                      ...
                      Row(
                        children: [
                          ...
                          otherProduct[index].productOfferPercentage!='0'?Text(
