...
class ReturnOrderBottomsheet extends StatefulWidget {
  ...
  ReturnOrderBottomsheet(this.onSaveCallback, this.order_auto_id,
      this.product_order_auto_id, this.customer_auto_id, this.admin_auto_id, this.baseUrl);

  @override
  _ReturnOrderBottomsheet createState() => _ReturnOrderBottomsheet(order_auto_id,
      product_order_auto_id, customer_auto_id, admin_auto_id, baseUrl);
}

class _ReturnOrderBottomsheet extends State<ReturnOrderBottomsheet> {

  String order_auto_id,product_order_auto_id,customer_auto_id,admin_auto_id, baseUrl;
  bool isApiCallProcessing=false;


  _ReturnOrderBottomsheet(this.order_auto_id, this.product_order_auto_id,
                            ...
                            children: <Widget>[
                              Row(
                                children: <Widget>[
                                  ...
                                  const Text(
                                    'Return Order',style: TextStyle(color: Colors.black87,fontSize: 14),
                                  ),
                                ],
                              ),
  ...
  returnOrderApi() async {
    ...
    var url = baseUrl+'api/' + return_order;
