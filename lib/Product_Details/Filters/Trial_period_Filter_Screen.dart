...
typedef OnSaveCallback = void Function(String min_trail_days,String max_trail_days);

class Trial_Period_Screen extends StatefulWidget {
  OnSaveCallback onSaveCallback;
  String min_trail_days;
  String max_trail_days;


  Trial_Period_Screen(this.onSaveCallback, this.min_trail_days, this.max_trail_days);

  @override
  _Trial_Period_ScreenState createState() => _Trial_Period_ScreenState(min_trail_days,max_trail_days);
}

class _Trial_Period_ScreenState extends State<Trial_Period_Screen> {
  ...
  _Trial_Period_ScreenState(this.min_trail_days, this.max_trail_days);
          ...
          Column(
            children: [
              Container(
                  ...
                  child: const Text("Select Trail Period Days",
...
*/
  ...
  void initState() {
   ...
   /* if(min_discount.isNotEmpty){
    ...
    if(min_trail_days.isNotEmpty){
      _starValue=double.parse(min_trail_days);
    }

    if(max_trail_days.isNotEmpty){
      _endValue=double.parse(max_trail_days);
    }
