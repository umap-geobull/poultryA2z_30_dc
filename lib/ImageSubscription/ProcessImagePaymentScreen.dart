...
import 'SubscriptionPlanModel/ImageSubscriptionPlanModel.dart';

class ProcessImagePaymentScreen extends StatefulWidget{
  GetImagePlans subscriptionPlan;
  late String transaction_id;

  ProcessImagePaymentScreen(this.subscriptionPlan,this.transaction_id);

  @override
  _ProcessImagePaymentScreenState createState() => _ProcessImagePaymentScreenState(subscriptionPlan,transaction_id);

}

class _ProcessImagePaymentScreenState extends State<ProcessImagePaymentScreen>{
  ...
  _ProcessImagePaymentScreenState(this.subscriptionPlan,this.transaction_id);
  ...
  Future purchasePlan() async {
    ...
    final body = {
      "plan_auto_id": subscriptionPlan.id,
      "payment_mode": 'Online',
...
print("sub_id"+subscriptionPlan.id+"\n"+"transaction_status"+transaction_id+"\n"+"userid"+user_auto_id);

    var url=AppConfig.grobizBaseUrl+image_subscriptions;
    ...
    if (response.statusCode == 200) {
      ...
      if(status==1){
        ...
        message='Your image plan has been purchased successfully';
