...
class EditBrandsStyle extends StatefulWidget {

  OnEditCallback onEditCallback;
  String id;

  @override
  _EditBrandsStyle createState() => _EditBrandsStyle(id);

  EditBrandsStyle(this.onEditCallback, this.id);
}

class _EditBrandsStyle extends State<EditBrandsStyle> {
  ...
  Color appLabelColor=const Color(0xff443a49),
      appHeaderColor=Colors.black87,webLabelColor=const Color(0xff443a49),webHeaderColor=Colors.black87,
      backgroundColor=Colors.white, title_backgroundColor=Colors.transparent;

  String title_alignment = '';

  String home_component_id;

  _EditBrandsStyle(this.home_component_id);
  ...
  Future getDetails() async {
    ...
    if (response.statusCode == 200) {
      ...
      if(status==1){
        ...
        homeComponentData=homeBrandDetails.getHomeComponentList[0];
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title:const Text('Edit brand component',style: TextStyle(color: appBarIconColor,fontFamily:'Lato',fontSize: 16),),
        actions: [
          isEditApiProcessing==true?
          const SizedBox(
            width: 80,
  ...
  app_view(){
    return Column(
      ...
      children: <Widget>[
        ...
        selectLayoutType(),
        const SizedBox(height: 10,),
        app_layout!=10 && app_layout!=9 && app_layout!=8?selectIconType():Container(),
