...
import 'package:poultry_a2z/Home/Components/AddNewComponent/Brand/BrandsFromHomePage.dart';
import 'package:poultry_a2z/Home/Components/AddNewComponent/Brand/selec_brands.dart';
...
import 'edit_brand_bottomsheet.dart';
...
class BrandsNew extends StatefulWidget {
  ...
  BrandsNew(this.iseditSwitched,this.onDeleteCallBack,this.onGoToListCallBack,this.componet_id,this.user_type,
      this.iconType,this.layoutType);
  
  @override
  _BrandsNew createState() => _BrandsNew(iseditSwitched,componet_id,iconType,layoutType);
}
...
class _BrandsNew extends State<BrandsNew> {
  ...
  _BrandsNew(this.iseditSwitched, this.componet_id,this.iconType,this.layoutType);
...
Color scrollbarColor=Colors.pinkAccent;
  ...
  goToNextScreen(int index){
    widget.onGoToListCallBack("brand", "","", brandsList[index].brandAutoId);
  }
  ...
  showAddBrand() {
    routes = MaterialPageRoute(builder: (context) => SelectBrands(onSavelistener,componet_id));
    Navigator.push(context, routes).then(onGoBack);
  }

  showBrandEdit() {
    routes = MaterialPageRoute(builder: (context) => EditBrandsStyle(onSavelistener,componet_id));
    Navigator.push(context, routes).then(onGoBack);
  }
              ...
              Container(
                ...
                Row(
                  ...
                  children: <Widget>[
                    ...
                    GestureDetector(
                      onTap: ()=>{
                        widget.onDeleteCallBack(componet_id)
                      },
                      child: Container(
                    ...
                    GestureDetector(
                      onTap: ()=>{
                        Navigator.push(context, MaterialPageRoute(builder: (context) => BrandsFromHomePage(componet_id)))
                      },
                      child: Container(
                        padding: const EdgeInsets.all(7),
