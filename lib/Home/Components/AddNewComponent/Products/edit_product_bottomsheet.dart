...
class EditProductStyle extends StatefulWidget {

  OnEditCallback onEditCallback;
  String id;

  @override
  _EditProductStyle createState() => _EditProductStyle(id);

  EditProductStyle(this.onEditCallback, this.id);
}

class _EditProductStyle extends State<EditProductStyle> {
  ...
  Color backgroundColor=Colors.white,appLabelColor=const Color(0xff443a49),
      appHeaderColor=Colors.black87,webLabelColor=const Color(0xff443a49),webHeaderColor=Colors.black87,
  ...
  _EditProductStyle(this.home_component_id);
  ...
  Future getDetails() async {
    ...
    if (response.statusCode == 200) {
      ...
      if(status==1){
        ...
        homeComponentData=homeComponentProductDetails.getHomeComponentList[0];
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title:const Text('Edit Product component',style: TextStyle(color: appBarIconColor,fontFamily:'Lato',fontSize: 16),),
        actions: [
          isEditApiProcessing==true?
          const SizedBox(
            width: 80,
