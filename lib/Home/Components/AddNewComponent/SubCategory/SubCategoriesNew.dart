...
import 'package:poultry_a2z/Home/Components/AddNewComponent/SubCategory/ShowSubcategoryListFromHome.dart';
...
import 'package:poultry_a2z/Home/Components/AddNewComponent/SubCategory/selec_sub_categories.dart';
...
import 'edit_subcategory_bottomsheet.dart';
...
class SubCategoriesNew extends StatefulWidget {
  ...
  SubCategoriesNew(this.iseditSwitched, this.onDeleteCallBack,this.onGoToListCallBack,this.component_id,this.user_type,
      this.iconType,this.layoutType);
  
  @override
  _SubCategoriesNew createState() => _SubCategoriesNew(iseditSwitched,component_id,iconType,layoutType);
}
...
class _SubCategoriesNew extends State<SubCategoriesNew> {
  ...
  _SubCategoriesNew(this.iseditSwitched,this.component_id,this.iconType,this.layoutType);

  String appLabelFont = 'Lato',appHeaderFont='Lato',headerTitle='';
  Color appLabelColor=const Color(0xff443a49),appHeaderColor=Colors.black87,backgroundColor=Colors.transparent,
              ...
              Container(
                  ...
                  Row(
                    ...
                    children: <Widget>[
                      ...
                      GestureDetector(
                        onTap: ()=>{
                          Navigator.push(context, MaterialPageRoute(builder: (context) => ShowSubcategoryFromHome(component_id)))
                        },
                        child: Container(
                          padding: const EdgeInsets.all(7),
  ...
  showAddCategory(){
    routes = MaterialPageRoute(builder: (context) => SelectSubCategory(onSavelistener,component_id));
    Navigator.push(context, routes).then(onGoBack);
  }

  showCategoryEdit() {
    routes = MaterialPageRoute(builder: (context) => EditSubCategoryStyle(onSavelistener,component_id));
    Navigator.push(context, routes).then(onGoBack);
  }
  ...
  goToNextScreen(int index){
    ...
    widget.onGoToListCallBack("subcategory",
        subcategoryList[index].mainCategoryAutoId,subcategoryList[index].subcategoryAutoId, "");
  }
