class HomeSliderDetails {
  ...
  HomeSliderDetails.fromJson(Map<String, dynamic> json){
    status = json['status'];
    msg = json['msg'];
...
class Content {
  ...
  late final String title;
  late final String componentAutoId;
  late final String registerDate;
  late final String adminAutoId;
  late final String updatedAt;
  late final String createdAt;
  ...
  Content.fromJson(Map<String, dynamic> json){
    ...
    title = json['title'];
    componentAutoId = json['component_auto_id'];
    registerDate = json['register_date'];
    adminAutoId = json['admin_auto_id'];
    updatedAt = json['updated_at'];
    createdAt = json['created_at'];
  ...
  Map<String, dynamic> toJson() {
    ...
    _data['title'] = title;
    _data['component_auto_id'] = componentAutoId;
    _data['register_date'] = registerDate;
    _data['admin_auto_id'] = adminAutoId;
    _data['updated_at'] = updatedAt;
    _data['created_at'] = createdAt;
