class HomeMainCategoryDetails {
  HomeMainCategoryDetails({
  ...
  HomeMainCategoryDetails.fromJson(Map<String, dynamic> json){
    status = json['status'];
    msg = json['msg'];
...
class Content {
  ...
  late final Null categoryAutoId;
  late final String mainCategoryName;
  late final String categoryImageApp;
  late final String categoryImageWeb;

  Content.fromJson(Map<String, dynamic> json){
    maincategoryAutoId = json['maincategory_auto_id'];
    categoryAutoId = null;
  ...
  Map<String, dynamic> toJson() {
    final _data = <String, dynamic>{};
    _data['maincategory_auto_id'] = maincategoryAutoId;
    _data['category_auto_id'] = categoryAutoId;
    _data['main_category_name'] = mainCategoryName;
