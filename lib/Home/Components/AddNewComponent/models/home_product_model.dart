...
class HomeComponentProductDetails {
  HomeComponentProductDetails({
  ...
  HomeComponentProductDetails.fromJson(Map<String, dynamic> json){
    status = json['status'];
    msg = json['msg'];
...
class GetHomeComponentList {
  ...
  late final List<ProductModel> content;
  ...
  GetHomeComponentList.fromJson(Map<String, dynamic> json){
    ...
    content = List.from(json['content']).map((e)=>ProductModel.fromJson(e)).toList();
  }
