...
class HomeOffer_3 extends StatefulWidget{
  OnGoToListCallBack onGoToListCallBack;
  String component_id;
  List<HomeOffers> offerList=[];
  String baseUrl;

  HomeOffer_3(this.component_id,this.offerList,this.baseUrl,this.onGoToListCallBack);

  @override
  _HomeOffer_3 createState() => _HomeOffer_3(component_id,offerList,baseUrl);
}

class _HomeOffer_3 extends State<HomeOffer_3> {
  _HomeOffer_3(this.component_id,this.offerList,this.baseUrl);
    ...
    return SizedBox(
      ...
      150: 300,
        child: GridView.builder(
          ...
          itemCount: offerList.length>4? 4:offerList.length,
