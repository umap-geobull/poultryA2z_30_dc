...
class HomeOffer_2 extends StatefulWidget{
  OnGoToListCallBack onGoToListCallBack;
  String component_id;
  List<HomeOffers> offerList=[];
  String baseUrl;

  HomeOffer_2(this.component_id,this.offerList,this.baseUrl,this.onGoToListCallBack);

  @override
  _HomeOffer_2 createState() => _HomeOffer_2(component_id,offerList,baseUrl,);
}

class _HomeOffer_2 extends State<HomeOffer_2> {
  _HomeOffer_2(this.component_id,this.offerList,this.baseUrl);
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      child: GridView.builder(
        ...
        itemCount: offerList.length>3? 3:offerList.length,
