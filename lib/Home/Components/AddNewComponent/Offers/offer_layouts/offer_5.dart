...
class HomeOffer_5 extends StatefulWidget{
  OnGoToListCallBack onGoToListCallBack;
  String component_id;
  List<HomeOffers> offerList=[];
  String baseUrl;

  HomeOffer_5(this.component_id,this.offerList,this.baseUrl,this.onGoToListCallBack);

  @override
  _HomeOffer_5 createState() => _HomeOffer_5(component_id,offerList,baseUrl);
}

class _HomeOffer_5 extends State<HomeOffer_5> {
  _HomeOffer_5(this.component_id,this.offerList,this.baseUrl);
