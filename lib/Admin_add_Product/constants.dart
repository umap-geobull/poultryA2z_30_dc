...
const kPrimaryColor1 = Color(0xFFFA7F52);
const kPrimaryLightColor = Color(0xFFFAF3EE);
const kPrimaryGradientColor = LinearGradient(
  begin: Alignment.topLeft,
  end: Alignment.bottomRight,
  colors: [Color(0xFFFFA53E), Color(0xFFFF7643)],
);
const vMenuGradientColor = LinearGradient(
  begin: Alignment.topLeft,
  end: Alignment.bottomRight,
  colors: [Color(0xFFCECCCB),Color(0xFFF3EDEA), ],
);
