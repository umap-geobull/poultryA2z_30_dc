...
// class Approved_Vendors extends StatefulWidget {
//   Approved_Vendors({
//     Key? key,
//     // required this.type,
...
//
//   @override
//   _Approved_VendorsState createState() =>
//       _Approved_VendorsState();
// }
//
// class _Approved_VendorsState extends State<Approved_Vendors> {
//   late Route routes;
...
//     }
//
//     var url = baseUrl + 'api/' + get_approved_vendor_list;
//
...
//     };
//     print("aprroved vendres are  $body");
//     print(url);
        ...
        children: <Widget>[
          ...
          SingleChildScrollView(
            child: Container(
                ...
                child: ListView.builder(
                  scrollDirection: Axis.vertical,
                  itemCount: approvedVendorList.length,
                  itemBuilder: (context, index) => InkWell(
                    onTap: () {
                      // Navigator.push(context,
                      // MaterialPageRoute(builder: (context) => VendorDetailsWithCustomer( vendor: vendor_list[index],)));
                        ...
                        child: Stack(
                          children: [
                            Column(
                              crossAxisAlignment: CrossAxisAlignment.start,
                              children: <Widget>[
                                approvedVendorList[index]["SUPPLIER_PROFILE"].isEmpty
                                    ? Expanded(
                                    flex: 5,
                                    child: Container(
                                      width:
                                  ...
                                  child: CachedNetworkImage(
                                    ...
                                    height: 220,
                                    imageUrl:
                                    // "https://grobiz.app/GRBCRM2022/PoultryEcommerce/images/products/${approvedVendorList[index]["SUPPLIER_PROFILE"]}",
                                    "https://grobiz.app/GRBCRM2022/PoultryEcommerce/images/profiles/${approvedVendorList[index]["SUPPLIER_PROFILE"]}",
                                    placeholder: (context, url) =>
                                    new Container(
                                      width: MediaQuery.of(context)
                                          .size
                                ...
                                Expanded(
                                    ...
                                    child: Padding(
                                      padding: EdgeInsets.only(
                                          ...
                                          bottom: 5),
                                      child: Text(
                                        approvedVendorList[index]["fields"][0]["field_value"].toString()
                                            .isEmpty
                                            ? "N.A."
                                            : "${approvedVendorList[index]["fields"][0]["field_value"]}",
                                        style: TextStyle(
                                            color: Colors.blueGrey,
                                            fontSize: 20),
                                      ),
          ...
          isApiCallProcessing == false && approvedVendorList.isEmpty
              ? Container(
              alignment: Alignment.center,
              width: MediaQuery.of(context).size.width,
              height: MediaQuery.of(context).size.height / 1.3,
