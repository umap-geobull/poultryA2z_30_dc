...
//       if (status == 1) {
//         print("resp get_vendor_approval_list   ${resp}  ");
//         vendorListNew = resp["data"];
//         print("resp vendorListNew  ${vendorListNew.length} ${vendorListNew}  ");
...
//     debugPrint("vendor pending approval screen ");
//     return Scaffold(
...
//                             SendApproval_vendor(jobid, 'Yes', category_id);
//                           },
    ...
    return Scaffold(
      ...
      body: Column(
        children: <Widget>[
          ...
          vendorListNew.isNotEmpty? SingleChildScrollView(
            child: Container(
                height: MediaQuery.of(context).size.height / 1.3,
                padding: const EdgeInsets.only(top: 10),
                ...
                child: ListView.builder(
                  scrollDirection: Axis.vertical,
                  itemCount: vendorListNew.length,
                        ...
                        child: Stack(
                          children: [
                            ...
                            Column(
                              crossAxisAlignment: CrossAxisAlignment.start,
                              children: <Widget>[
                                vendorListNew[index]["SUPPLIER_PROFILE"].isEmpty
                                    ? Expanded(
                                    flex: 5,
                                    child: Container(
                                      width:
                                  ...
                                  child: CachedNetworkImage(
                                    ...
                                    height: 220,
                                    imageUrl:
                                    // "https://grobiz.app/GRBCRM2022/PoultryEcommerce/images/products/${vendorListNew[index]["SUPPLIER_PROFILE"].toString()}",
                                    "https://grobiz.app/GRBCRM2022/PoultryEcommerce/images/profiles/${vendorListNew[index]["SUPPLIER_PROFILE"].toString()}",
                                    placeholder: (context, url) =>
                                     Container(
                                      width: MediaQuery.of(context)
                                          .size
                                ...
                                Expanded(
                                    ...
                                    child: Padding(
                                      padding: const EdgeInsets.only(
                                          ...
                                          top: 5,
                                          bottom: 5),
                                      child: Text(vendorListNew[index]["fields"][0]["field_value"].toString().isEmpty
                                            ? "N.A."
                                            : "${vendorListNew[index]["fields"][0]["field_value"]}",
                                        ...
                                        child: Padding(
                                          ...
                                          child: Row(
                                            ...
                                            children: <Widget>[
                                              ...
                                              Flexible(
                                                  child: Text(
                                                    vendorListNew[index]["fields"][1]["field_value"].toString()
                                                        .isEmpty
                                                        ? "N.A."
                                                        : "${vendorListNew[index]["fields"][1]["field_value"]}",
                                                  ))
                                            ],
                                          ),
                                        ))),
                                          ...
                                          Flexible(
                                            ...
                                            child: SizedBox(
                                              ...
                                              child: ElevatedButton(
                                                ...
                                                onPressed: () {
                                                  showAlert(
                                                      vendorListNew[index]["_id"],
                                                      vendorListNew[index]["CATEGORY_AUTO_ID"]);
                                                },
                                                child: const Center(
                                                  child: Text(
                                                    'Approve',
          ...
          isApiCallProcessing == false && vendorListNew.isEmpty
              ? Container(
              alignment: Alignment.center,
              width: MediaQuery.of(context).size.width,
              height: MediaQuery.of(context).size.height / 1.3,
